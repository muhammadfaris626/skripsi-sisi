...
class RequestTypePolicy
{
    ...
    {
        return $user->can('menu: requestType');
    }
    ...
    {
        return $user->can('read: requestType');
    }
    ...
    {
        return $user->can('create: requestType');
    }
    ...
    {
        return $user->can('update: requestType');
    }
    ...
    {
        return $user->can('delete: requestType');
    }
}
